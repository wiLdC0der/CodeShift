...
export type StorageHash =
  StorageHashBase<'582b94cdae2a508f2c24fc3eae2aad47922fef42061c9120ceff8cfeeb9ebc5c'>;
export type ExecutionHash =
  ExecutionHashBase<'52fd024d6736ba6235b11ba2815220c9ed32003057b0bddb5fcb1514792c6c65'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Assessment: {
      ...
      readonly syntaxScore: CodecTypes['pg/int4@1']['output'];
      readonly dataStructuresScore: CodecTypes['pg/int4@1']['output'];
      readonly algorithmsScore: CodecTypes['pg/int4@1']['output'];
      readonly oopScore: CodecTypes['pg/int4@1']['output'];
    ...
    readonly UserProgress: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly userId: CodecTypes['pg/text@1']['output'];
      readonly conceptKey: CodecTypes['pg/text@1']['output'];
      readonly mastery: CodecTypes['pg/int4@1']['output'];
      readonly completed: CodecTypes['pg/bool@1']['output'];
      readonly lastVisited: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Assessment: {
      ...
      readonly syntaxScore: CodecTypes['pg/int4@1']['input'];
      readonly dataStructuresScore: CodecTypes['pg/int4@1']['input'];
      readonly algorithmsScore: CodecTypes['pg/int4@1']['input'];
      readonly oopScore: CodecTypes['pg/int4@1']['input'];
    ...
    readonly UserProgress: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly userId: CodecTypes['pg/text@1']['input'];
      readonly conceptKey: CodecTypes['pg/text@1']['input'];
      readonly mastery: CodecTypes['pg/int4@1']['input'];
      readonly completed: CodecTypes['pg/bool@1']['input'];
      readonly lastVisited: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
  };
};
...
export namespace Models {
  export type public_User = {
    ...
    learningProfile: public_LearningProfile | null;
    progress: public_UserProgress[];
    readonly [RelationKeys]?: 'assessments' | 'learningProfile' | 'progress';
  };
  export type public_LearningProfile = {
    ...
    syntaxScore: CodecTypes['pg/int4@1']['output'];
    dataStructuresScore: CodecTypes['pg/int4@1']['output'];
    algorithmsScore: CodecTypes['pg/int4@1']['output'];
    oopScore: CodecTypes['pg/int4@1']['output'];
  ...
  export type public_UserProgress = {
    id: CodecTypes['pg/text@1']['output'];
    userId: CodecTypes['pg/text@1']['output'];
    conceptKey: CodecTypes['pg/text@1']['output'];
    mastery: CodecTypes['pg/int4@1']['output'];
    completed: CodecTypes['pg/bool@1']['output'];
    lastVisited: CodecTypes['pg/timestamptz-temporal@1']['output'];
    user: public_User;
    readonly [RelationKeys]?: 'user';
  };
  export type public_Assessment = {
    ...
    oopScore: CodecTypes['pg/int4@1']['output'];
    overallScore: CodecTypes['pg/int4@1']['output'];
    completedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    user: public_User;
    readonly [RelationKeys]?: 'user';
  };
}
          ...
          readonly table: {
            readonly assessment: {
              columns: {
                ...
                readonly syntaxScore: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
                readonly dataStructuresScore: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
                readonly algorithmsScore: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
              ...
              indexes: readonly [
                {
                  readonly name: 'assessment_userId_idx_a489d58a';
                  readonly prefix: 'assessment_userId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'learningProfile';
                    readonly columns: readonly ['userId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly userProgress: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['userId', 'conceptKey'] }];
              indexes: readonly [
                {
          ...
          readonly Assessment: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly syntaxScore: { readonly column: 'syntaxScore' };
                readonly dataStructuresScore: { readonly column: 'dataStructuresScore' };
                readonly algorithmsScore: { readonly column: 'algorithmsScore' };
                readonly oopScore: { readonly column: 'oopScore' };
          ...
          readonly UserProgress: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly conceptKey: { readonly column: 'conceptKey' };
                readonly mastery: { readonly column: 'mastery' };
                readonly completed: { readonly column: 'completed' };
                readonly lastVisited: { readonly column: 'lastVisited' };
              };
            };
          };
        };
